...
export function registerCommands(bot) {
  ...
  for (const [command, mode] of Object.entries({ preview:'preview', beautify:'beautify', validate:'validate', fix:'fix', replicate:'replicate' })) bot.command(command, (ctx) => setMode(ctx, mode));
